...
class ViT(L.LightningModule):
    def __init__(self, cfg, train_loader):
        ...
        model_kwargs = {
            ...
            "hidden_dim": cfg["MODEL_ARGS"]["hidden_dim"],
            "num_heads": cfg["MODEL_ARGS"]["num_heads"],
            "num_layers": cfg["MODEL_ARGS"]["num_layers"],
            "patch_size": cfg["MODEL_ARGS"]["patch_size"],
            "num_channels": cfg["MODEL_ARGS"]["num_channels"],
            "num_patches": cfg["MODEL_ARGS"]["num_patches"],
